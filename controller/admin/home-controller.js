        ...
        .exec(function(err,comment){
            ...
            .exec(function(err,data){
                ...
                .exec(function(err,feedback){
                    res.render('admin/index', { main: main,comment:comment,feedback:feedback,property:property,str:str,cart:cart,url: url })
                })
...
router.get('/review(/:page)?',async (req,res)=>{
    ...
    .exec(function(err,data){
        ...
        res.render('admin/index', { main: main,str:str,url: url,page: page, totalPage: totalPage })
    })
})
...
router.get('/pending(/:page)?',async (req,res)=>{
    ...
    .exec(function(err,data){
        ...
        res.render('admin/index', {main: main,pending:pending,url: url,page: page, totalPage: totalPage})
    })
})
router.get('/completed(/:page)?',async (req,res)=>{
    ...
    .exec(function(err,data){
        ...
        var totalPage = Math.ceil(totalData / limit);
        res.render('admin/index', {main: main,completed:completed,url: url,page: page, totalPage: totalPage })
    })
})
router.get('/refunded(/:page)?',async (req,res)=>{
    ...
    .exec(function(err,data){
        ...
        var totalPage = Math.ceil(totalData / limit);
        res.render('admin/index', {main: main,refunded:refunded,url: url,page: page, totalPage: totalPage })
    })
})
